...
<div class="wrap-left">
<h2 class="menu05">관리서비스</h2> <!--메뉴별로 클래스이름 바꿔주세요 menu01, menu03, menu04 , 관리자페이지menu05 ,마이페이지 menu06-->
 	<ul class="lnb">
		<li class="submenuOn">
			<a href="#none" >사용자관리</a>
			<ul class="left_Msub">
				<li><a href="/mng/umt/mberManage.do">회원관리</a></li>
				<li><a href="/mng/ujm/mberJoinManage.do">가입승인관리</a></li>
			</ul>
		</li>
		<li class="submenuOn">
			<a href="#none" >로그관리</a>
		...
		<li class="submenuOn">
			...
			<ul class="left_Msub">			
				...
				<li><a href="/mng/sec/rpm/authorRoleList.do">권한 롤 관리</a></li>
				<li><a href="/mng/sec/rmt/roleList.do">롤 관리</a></li>
				<li><a href="/mng/sec/rhm/roleHierarchyList.do">롤 상하관계관리</a></li>
		...
		<li class="submenuOn">
			<a href="#none">게시물관리</a>
			<ul class="left_Msub">
				<li><a href="/mng/bbs/ntb/noticeList.do">공지사항관리</a></li>
				<li><a href="/mng/bbs/art/articleList.do">게시판관리</a></li>
			</ul>
		</li>
		<!-- <li class="submenuOn">
			<a href="#none">보고서관리</a>
			<ul class="left_Msub">
				<li><a href="/mng/rpt/bsc/rptBscFileHistList.do">기초조사 이력관리</a></li>
			</ul>
		</li> -->
		<li class="submenuOn">
 		...
 		<li class="submenuOn">
			<a href="#none">메뉴관리</a>
			<ul class="left_Msub">
				<li><a href="/mng/prm/programListManageSelect.do">프로그램목록관리</a></li>
				<li><a href="/mng/mnu/mpm/menuManageSelect.do">메뉴목록관리</a></li>
				<li><a href="/mng/mnu/mcm/menuCreatManageSelect.do">메뉴생성관리</a></li>
			</ul>
		</li>
	</ul>
</div> 