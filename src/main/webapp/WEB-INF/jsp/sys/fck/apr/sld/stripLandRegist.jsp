...
<validator:javascript formName="fckAprStripLand" staticJavascript="false" xhtml="true" cdata="false"/>
...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<form:form id="listForm" commandName="fckAprStripLand" action="${pageContext.request.contextPath}/sys/fck/apr/sld/registFckAprStripLand.do" method="post">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3" class="cs3">
							    <form:input path="id" title="${title} ${inputTxt}" />
