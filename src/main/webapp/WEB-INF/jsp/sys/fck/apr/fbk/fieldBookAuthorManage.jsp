...
<c:set var="pageTitle"><spring:message code="sysFckApr.fieldBookAuthorManage.title"/></c:set>
...
<div class="wrap-right" id="Cont">
	...
	<h3>${pageTitle}</h3>
	<div id="contents">
		<form:form id="listForm" commandName="resultList" action="/sys/fck/apr/fbk/updateCnrsSpceAuthorMgt.do" method="post" enctype="multipart/form-data">		
		<div class="BoardDetail">
			<input name="mstId" type="hidden" value="${searchItemVO.MST_ID}"/>
			<input name="svytype" type="hidden" value="APR"/>
			...
			<table summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
				...
				<tbody>
					<tr>
						<th><spring:message code="sysFckApr.fieldBookAuthorManage.creatUser"/></th><!-- 공유방 등록자 -->
						<td>
...
<%-- 			<h3>${subTitle}</h3> --%>
			...
			<thead>
			<tr>				
				<th><spring:message code="sysFckApr.fieldBookVO.deptname" /></th><!-- 부서명 -->
				<th><spring:message code="sysFckApr.fieldBookVO.authory" /></th><!-- 권한자명 -->
				<th></th>
			</tr>
			</thead>
				<tbody class="ov">
