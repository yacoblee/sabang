...
<c:set var="pageTitle"><spring:message code="sysFckPcs.fieldBookList.title"/></c:set>
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<fieldset>
			...
			<form id="listForm" action="/sys/fck/pcs/fbk/selectPcsFieldBookList.do" method="post">
				...
				<div class="search">
					<table class="tableWid_M" summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
						...
						<tbody>
							<tr>
								<th><spring:message code="sysFckPcs.fieldBookVO.corpname"/></th><!-- 회사명 -->
								<td>
									<label for="mst_corpnameView" class="Hidden"><spring:message code="sysFckPcs.fieldBookVO.corpname"/></label>
									<select id="mst_corpnameView" name="mst_corpnameView" title="<spring:message code="sysFckPcs.fieldBookVO.corpname"/>" class="mo_mt5">
								...
								<th><spring:message code="sysFckPcs.fieldBookVO.partname"/></th><!-- 사업지구명 -->
								<td>
									<label for="mst_partnameView" class="Hidden"><spring:message code="sysFckPcs.fieldBookVO.partname"/></label>
									<input type="text" id="mst_partname"  name="mst_partnameView" class="mo_mt5 input_null" />
								</td>
								<th><spring:message code="sysFckPcs.fieldBookVO.year"/></th><!-- 등록연도 -->
								<td>
									<label for="svy_yearView" class="Hidden"><spring:message code="sysFckPcs.fieldBookVO.year"/></label>
									<select id="svy_yearView" name="svy_yearView" title="<spring:message code="sysFckPcs.fieldBookVO.year"/>">
							...
							<tr>
								<th><spring:message code="sysFckPcs.fieldBookVO.id"/></th><!-- 공유방ID -->
								<td>
									<label for="idView" class="Hidden"><spring:message code="sysFckPcs.fieldBookVO.id"/></label>
									<input type="text" id="id" value="" name="idView" class="mo_mt5 input_null" />
								</td>
								<th><spring:message code="sysFckPcs.fieldBookVO.create_user"/></th><!-- 등록자 -->
								<td>
									<label for="mst_create_userView" class="Hidden"><spring:message code="sysFckPcs.fieldBookVO.create_user"/></label>
									<input type="text" id="mst_create_user" value="" name="mst_create_userView" class="mo_mt5 input_null" />
								</td>
							</tr>
						</tbody>
					</table>
		...
		<div class="BoardList">
			<span class="ListCount">Total : <strong>1</strong> Page : <strong>1/1</strong>
			...
			<tr>				
				...
				<th><spring:message code="sysFckPcs.fieldBookVO.corpname" /></th><!-- 회사명 -->
				<th><spring:message code="sysFckPcs.fieldBookVO.partname" /></th><!-- 사업지구명 -->
				<th><spring:message code="sysFckPcs.fieldBookVO.create_user" /></th><!-- 생성자 -->
				<th><spring:message code="sysFckPcs.fieldBookVO.registered" /></th><!-- 생성일 -->
				<th><spring:message code="sysFckPcs.fieldBookVO.totcnt" /></th><!-- 조사데이터갯수 -->
				<th></th>
			</tr>
			</thead>
				<tbody class="ov">		
