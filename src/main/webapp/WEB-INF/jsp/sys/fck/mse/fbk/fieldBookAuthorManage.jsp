...
<c:set var="pageTitle"><spring:message code="sysFckMse.fieldBookAuthorManage.title"/></c:set>
...
<div class="wrap-right" id="Cont">
	...
	<h3>${pageTitle}</h3>
	<div id="contents">
		<form:form id="listForm" commandName="resultList" action="/sys/fck/mse/fbk/updateCnrsSpceAuthorMgt.do" method="post" enctype="multipart/form-data">		
		<div class="BoardDetail">
			...
			<table summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
				...
				<tbody>
					<tr>
						<th><spring:message code="sysFckMse.fieldBookAuthorManage.creatUser"/></th><!-- 공유방 등록자 -->
						<td>
...
<%-- 			<h3>${subTitle}</h3> --%>
			...
			<thead>
			<tr>				
				<th><spring:message code="sysFckMse.fieldBookVO.deptname" /></th><!-- 부서명 -->
				<th><spring:message code="sysFckMse.fieldBookVO.authory" /></th><!-- 권한자명 -->
				<th></th>
			</tr>
			</thead>
				<tbody class="ov">
