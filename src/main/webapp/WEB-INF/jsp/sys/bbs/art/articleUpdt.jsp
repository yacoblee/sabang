...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<form:form id="listForm" commandName="articleVO" action="/sys/bbs/art/articleUpdate.do" method="post" enctype="multipart/form-data">
		...
		<div class="BoardDetail">
			...
			<caption class="Hidden">${pageTitle} <spring:message code="title.detail" /></caption>
				...
				<!-- 글 제목 -->
				<c:set var="title"><spring:message code="sysBbs.articleVO.updt.nttSj" /></c:set>
				<tr>
				...
				<!-- 글 내용  -->
				<c:set var="title"><spring:message code="sysBbs.articleVO.updt.nttCn" /></c:set>
				<tr>
				...
				<c:if test="${not empty articleVO.atchFileId}">
					...
					<tr>
						<th>${title}</th>
						<td class="nopd" colspan="3">
							<c:import url="/sys/bbs/art/selectFileInfsForUpdate.do" charEncoding="utf-8">
