...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		...
		<form:form id="listForm" commandName="resultList" action="/sys/vyt/frd/fbk/updateCnrsSpceAuthorMgt.do" method="post" enctype="multipart/form-data">		
		<div class="BoardDetail">
				<input name="svytype" type="hidden" value="FRD"/>
