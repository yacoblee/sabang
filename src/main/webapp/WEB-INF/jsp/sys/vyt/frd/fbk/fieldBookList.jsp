...
<c:set var="pageTitle"><spring:message code="sysVytFrd.fieldBookList.title"/></c:set>
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<fieldset>
			...
			<form id="searchForm" action="/sys/vyt/frd/fbk/selectFrdFieldBookList.do" method="post">
				<input name="id" type="hidden" value="<c:out value='${searchVO.id}'/>">
				<input name="mst_id" type="hidden" value="">
				<input name="mst_corpname" type="hidden" value="한국치산기술협회">
				...
				<div class="search">
					<table class="tableWid_M" summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
						...
						<tbody>
							<tr>
								<th><spring:message code="sysVytFrd.fieldBookVO.partname"/></th><!-- 사업지구명 -->
								<td>
									<label for="mst_partnameView" class="Hidden"><spring:message code="sysLssBsc.fieldBookVO.partname"/></label>
									<input type="text" id="mst_partnameView" value="<c:out value='${searchVO.mst_partname}'/>" name="mst_partnameView" class="mo_mt5 input_null" />
								</td>
								<th><spring:message code="sysVytFrd.fieldBookVO.year"/></th><!-- 등록연도 -->
								<td>
							...
							<tr>
								<th><spring:message code="sysVytFrd.fieldBookVO.mstId"/></th><!-- 공유방ID -->
								<td>
								...
								<th><spring:message code="sysVytFrd.fieldBookVO.create_user"/></th><!-- 생성자 -->
								<td>
		...
		<div class="BoardList">
			<form id="listForm" action="/sys/vyt/frd/fbk/selectFrdFieldBookList.do" method="post">
			...
			<caption class="Hidden">${pageTitle} <spring:message code="title.list" /></caption>
				...
				<tr>
					<th><spring:message code="sysVytFrd.fieldBookVO.mstId"/></th><!-- 공유방ID -->
					<th><spring:message code="sysVytFrd.fieldBookVO.corpname"/></th><!-- 회사명 -->
					<th><spring:message code="sysVytFrd.fieldBookVO.partname"/></th><!-- 사업지구명 -->
					<th><spring:message code="sysVytFrd.fieldBookVO.create_user"/></th><!-- 생성자 -->
					<th><spring:message code="sysVytFrd.fieldBookVO.registered"/></th><!-- 등록일자 -->
					<th><spring:message code="sysVytFrd.fieldBookVO.totcnt"/></th><!-- 건수 -->
					<th></th><!-- 조회버튼 -->
				</tr>
				</thead>
				<tbody class="ov">
