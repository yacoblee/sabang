...
<div id="analDiv">
	<div class="BoardDetail">
		...
		<form id="insertForm" action="/sys/vyt/frd/sld/selectSldReportImgAll.do">
			<input name="smid" type="hidden" value="<c:out value="${smid}"/>">
			<input name="sldId" type="hidden" value="<c:out value="${sldId}"/>">
			...
			<table summary="<spring:message code="common.summary.inqire" arguments="${pageTitle}" />">
			<caption class="Hidden">대상지 분석</caption>
				<colgroup>
					<col width="25%"/>
					<col width="25%"/>
					<col width="25%"/>
			...
			<caption class="Hidden">대상지 분석</caption>
	     	...
	     	<div class="BtnGroup">
				...
				<div class="BtnRightArea">
					...
					<button type="button" class="add-btn" onclick="javascript:fnSvySldAnalRegist(<c:out value="${sldId}"/>,<c:out value="${smid}"/>); return false;"><spring:message code="title.create" /></button>
				</div>
			</div>
		</form>
   </div>
