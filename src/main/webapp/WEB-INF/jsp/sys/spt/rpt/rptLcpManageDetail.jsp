...
<c:set var="pageTitle"><spring:message code="sysSptRpt.reportManage.LssLcpReport.view"/></c:set>
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<fieldset>
			...
			<form id="listForm" action="/sys/spt/rpt/rptLcpManageDetail.do" method="post">
		...
		<div class="BoardList">
			...
			<div class="BtnGroup">
				...
				<button type="button" class="download-btn" onclick="javascript:fncAllCheckReport('LCP'); return false;">전체보고서</button>
				<button type="button" class="download-btn" onclick="javascript:fncMultiCheckReport('LCP'); return false;">보고서</button>
				<button type="button" class="list-btn" onclick="location.href='/sys/spt/rpt/selectRptLcpManageList.do'"><spring:message code="button.list" /></button>
				</div>
			</div>
			<div class="Page">
...
<script>
	function linkPage(pageNo){
		...
		$("#listForm").attr("action","<c:url value='/sys/spt/rpt/rptLcpManageDetail.do'/>");
		$("#listForm").submit();
	}
</script>