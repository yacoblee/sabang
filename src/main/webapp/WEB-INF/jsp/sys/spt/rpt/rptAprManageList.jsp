...
<c:set var="pageTitle"><spring:message code="sysSptRpt.reportManage.FckAprReport"/></c:set>
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<fieldset>
			...
			<form id="listForm" action="/sys/spt/rpt/selectRptAprManageList.do" method="post">
		...
		<div class="BoardList">
			<span class="ListCount">Total : <strong><c:out value="${paginationInfo.totalRecordCount}"/></strong> Page : <strong><c:out value="${paginationInfo.currentPageNo}"/>/<c:out value="${paginationInfo.totalPageCount}"/></strong>
				...
				<button type="button" class="download-btn fr" onclick="javascript:fncAllCheckReport('APR'); return false;">전체보고서</button>
				<button type="button" class="download-btn fr" onclick="javascript:fncMultiCheckReport('APR'); return false;">보고서</button>
...
<script>
	function linkPage(pageNo){
		...
		$("#listForm").attr("action","<c:url value='/sys/spt/rpt/selectRptAprManageList.do'/>");
		$("#listForm").submit();
	}
</script>