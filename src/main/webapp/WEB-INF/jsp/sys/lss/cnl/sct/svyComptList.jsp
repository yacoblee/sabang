...
<div class="wrap-right" id="Cont">
	<ul class="breadcrumbs">
		...
		<li><a href="#">취약지역해제조사</a></li>
	</ul>
	<h3>${pageTitle} <spring:message code="title.list"/></h3>
	<div id="contents">
		<fieldset>
			<legend class="Hidden">검색테이블</legend>
			<form id="listForm" action="/sys/lss/cnl/sct/selectCnlSvyComptList.do" method="post">
				...
				<div class="search">
					<table  class="tableWid_L" summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
						...
						<tbody>
							<tr>
								<th><spring:message code="sysLssCnl.stripLandVO.type"/><span class="pilsu" title="<spring:message code="title.tootip.msg" arguments="엑셀다운로드" />">*</span></th><!-- 조사유형 -->
								<td>
									<label for="svyTypeView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.type"/></label>
									<select id="svyTypeView" name="svyTypeView" title="<spring:message code="sysLssCnl.stripLandVO.type"/>">
								...
								<th><spring:message code="sysLssCnl.stripLandVO.date"/></th><!-- 조사일자 -->
								<td colspan="2">
									<label for="svyYearView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.year"/></label>
									<select id="svyYearView" name="svyYearView" title="<spring:message code="sysLssCnl.stripLandVO.year"/>" onchange="fncSvyYearChange(); return false;">
									...
									<label for="svyMonthView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.month"/></label>
									<select id="svyMonthView" name="svyMonthView" title="<spring:message code="sysLssCnl.stripLandVO.month"/>">
							...
							<tr>
								...
								<td colspan="4">
									<label for="svySdView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.sd"/></label>
									<select id="svySdView" name="svySdView" title="<spring:message code="sysLssCnl.stripLandVO.sd"/>" onchange="fncAdministCtprvnChange(event); return false;">
									...
									<label for="svySggView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.sgg"/></label>
									<select id="svySggView" name="svySggView" title="<spring:message code="sysLssCnl.stripLandVO.sgg"/>" onchange="fncAdministSignguChange(event); return false;">
									...
									<label for="svyEmdView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.emd"/></label>
									<select id="svyEmdView" name="svyEmdView" title="<spring:message code="sysLssCnl.stripLandVO.emd"/>" onchange="fncAdministEmdChange(event); return false;">
									...
									<label for="svyRiView" class="Hidden"><spring:message code="sysLssCnl.stripLandVO.ri"/></label>
									<select id="svyRiView" name="svyRiView" title="<spring:message code="sysLssCnl.stripLandVO.ri"/>">
							...
							<tr>
								...
								<td>
									<label for="sysLssCnl.svyComptVO.svyId" class="Hidden"><spring:message code="sysLssCnl.svyComptVO.svyId"/></label>
								...
								<td>
									<label for="sysLssCnl.svyComptVO.svyUser" class="Hidden"><spring:message code="sysLssCnl.svyComptVO.svyUser"/></label>
									<input type="text" id="svyUser" value="<c:out value='${searchVO.svyUser}'/>" name="svyUserView" class="mo_mt5 input_null" />
								</td>
								<th><spring:message code="sysLssCnl.svyComptVO.mstNm"/></th><!-- 공유방명 -->
								<td colspan="2">
									<label for="sysLssCnl.svyComptVO.mstNm" class="Hidden"><spring:message code="sysLssCnl.svyComptVO.mstNm"/></label>
...
<!-- 			<button class="reset-btn fr" onclick="javascript:fnUpdateLocReCreatePopup(); return false;">위치도재생성</button> -->
			...
			<caption class="Hidden">${pageTitle} <spring:message code="title.list" /></caption>
				...
				<tr>
					...
					<td><a href="<c:url value='/sys/lss/cnl/sct/selectCnlSvyComptDetail.do'/>?gid=${resultInfo.gid}" onClick="javascript:fncSvyComptDetail('<c:out value="${resultInfo.gid}"/>');return false;"><c:out value='${resultInfo.svyId}'/></a></td>
					...
					<td>
						...
						<button title="<spring:message code="button.movedMap"/>" class="map-btn-m" onclick="javascript:fncOpenMap('CNL','<c:out value="${resultInfo.gid}"/>'); return false;"></button>
<%-- 						<button title="<spring:message code="sysLssCnl.svyComptGeom.title"/>" class="modify-btn-m" onclick="javascript:fncSvyComptGeomView('<c:out value="${resultInfo.gid}"/>');return false;"></button> --%>
						<sec:authorize access="hasAnyRole('ROLE_ADMIN_CNL','ROLE_SUB_ADMIN','ROLE_ADMIN')">
