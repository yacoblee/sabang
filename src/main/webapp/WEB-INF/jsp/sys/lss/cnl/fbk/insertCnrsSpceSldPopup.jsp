...
<div class="sub-upload">
    <div class="BoardDetail">
    	<form:form id="insertForm" modelAttribute="fieldBookVO" commandName="fieldBookVO" method="post" action="/sys/lss/cnl/fbk/insertCnrsSpceSld.do">
    	<input type="hidden" value="${mst_id}" name="mst_id" />
    	<input type="hidden" value="${mst_create_user}" name="mst_create_user" />
