...
<div class="wrap-right" id="Cont">
	...
	<fieldset>
				<legend class="Hidden">검색테이블</legend>
					<form id="searchForm" action="/sys/lss/cnl/fbk/selectFieldBookDetail.do" method="post">
			...
			<fieldset>
			<form id="listForm" action="/sys/lss/cnl/fbk/selectFieldBookDetail.do" method="post">
				<input name="smid" type="hidden" value="">
			...
			<span class="ListCount">Total : <strong><c:out value="${paginationInfo.totalRecordCount}"/></strong> Page : <strong><c:out value="${paginationInfo.currentPageNo}"/>/<c:out value="${paginationInfo.totalPageCount}"/></strong>
				<sec:authorize access="hasAnyRole('ROLE_ADMIN_CNL','ROLE_SUB_ADMIN','ROLE_ADMIN')">
					<button style="float:right;" type="button" class="add-btn" onclick="javascript:fnManageCnrsSpceAuthory('<c:out value="${result.id}"/>');"><spring:message code="sysLssCnl.stripLand.authorManage" /></button>
					<button style="float:right;" type="button" class="save-btn" onclick="javascript:fnInsertCnrsSpceSldPopup('<c:out value="${result.id}"/>');"><spring:message code="sysLssBsc.stripLand.upload" /></button>
				</sec:authorize>
				<sec:authorize access="!hasAnyRole('ROLE_ADMIN_CNL','ROLE_SUB_ADMIN','ROLE_ADMIN')">
			...
			<div class="BtnGroup">
				<div class="BtnRightArea">
					<sec:authorize access="hasAnyRole('ROLE_ADMIN_CNL','ROLE_SUB_ADMIN','ROLE_ADMIN')">
					<button type="button" class="del-btn" onclick="javascript:fnDeleteCnrsSpce('<c:out value="${result.id}"/>');"><spring:message code="sysLssCnl.deleteFieldBook.title" /></button>
<%-- 					<button type="button" class="modify-btn" onclick="javascript:fnUpdateCnrsSpceView('<c:out value="${result.id}"/>');"><spring:message code="title.update" /></button> --%>
					...
					<button type="button" class="list-btn" onclick="javascript:fnList('/sys/lss/cnl/fbk/selectFieldBookList.do'); return false;"><spring:message code="button.list" /></button>
				</div>
			</div>
			<div class="Page">
