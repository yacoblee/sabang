...
<c:set var="pageTitle"><spring:message code="sysLssWka.fieldBookAuthorManage.title"/></c:set>
...
<div class="wrap-right" id="Cont">
	...
	<h3>${pageTitle}</h3>
	<div id="contents">
		<form:form id="insertForm" commandName="resultList" action="/sys/lss/wka/fbk/updateCnrsSpceAuthorMgt.do" method="post" enctype="multipart/form-data">		
		<div class="BoardDetail">
				<input name="svytype" type="hidden" value="WKA"/>
				...
				<table summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
					...
					<tbody>
						<tr>
							<th><spring:message code="sysLssWka.fieldBookAuthorManage.creatUser"/></th><!-- 공유방 등록자 -->
							<td>
...
<%-- 			<h3>${subTitle}</h3> --%>
			...
			<thead>
			<tr>				
				<th><spring:message code="sysLssWka.fieldBookVO.deptname" /></th><!-- 부서명 -->
				<th><spring:message code="sysLssWka.fieldBookVO.authory" /></th><!-- 권한자명 -->
				<th></th>
			</tr>
			</thead>
				<tbody class="ov">
