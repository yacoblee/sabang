...
<c:set var="subTitle"><spring:message code="sysLssWka.updatefieldBookItem.title"/></c:set>
<div class="wrap-right" id="Cont">
	...
	<h3>${pageTitle}</h3>
	<div id="contents">
		<form id="listForm" action="/sys/lss/wka/fbk/updateFieldBookView.do" method="post">
				...
				<caption class="Hidden">${subTitle} <spring:message code="title.detail" /></caption>
					<thead>
						<tr>
							...
							<th><spring:message code="sysLssWka.stripLandVO.compAt" /></th>
						</tr>
					</thead>
					<tbody class="ov">
