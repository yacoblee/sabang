...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<form:form id="listForm" commandName="lssBscStripLand" action="${pageContext.request.contextPath}/sys/lss/bsc/sld/registLssBscStripLand.do" method="post">
						...
						<tr>
							...
							<td>
								<form:select path="region1" title="${title} ${inputTxt}" cssClass="txt" onchange="fncRegionChange(event); return false;">
									<form:option value="" label="${inputSelect}"/>
									<form:options items="${regionCodeList}" itemValue="code" itemLabel="codeNm" />
								</form:select>
