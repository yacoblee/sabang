...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<fieldset>
			...
			<form id="listForm" action="/sys/lss/bsc/sct/selectBscSvyComptList.do" method="post">
					...
					<table  class="tableWid_L" summary="<spring:message code="common.search.summary.list" arguments="${pageTitle}" />">
						...
						<tbody>
							<tr>
								...
								<td colspan="2">
									<label for="svyRegion1View" class="Hidden"><spring:message code="sysLssBsc.stripLandVO.region1"/></label>
									<select id="svyRegion1View" name="svyRegion1View" title="<spring:message code="sysLssBsc.stripLandVO.region1"/>" onchange="fncRegionChange(event); return false;">
									...
									<label for="svyRegion2View" class="Hidden"><spring:message code="sysLssBsc.stripLandVO.region2"/></label>
									<select id="svyRegion2View" name="svyRegion2View" title="<spring:message code="sysLssBsc.stripLandVO.region2"/>" >
		...
		<div class="BoardList">
			...
			<caption class="Hidden">${pageTitle} <spring:message code="title.list" /></caption>
				...
				<tr>
					...
					<td><a href="<c:url value='/sys/lss/bsc/sct/selectBscSvyComptDetail.do'/>?gid=${resultInfo.gid}" onClick="javascript:fncSvyComptDetail('<c:out value="${resultInfo.gid}"/>');return false;"><c:out value='${resultInfo.svyId}'/></a></td>
					...
					<td><c:out value='${resultInfo.svyRegion1}'/> <c:out value='${resultInfo.svyRegion2}'/></td>					
					...
					<td>
						...
						<button title="<spring:message code="button.movedMap"/>" class="map-btn-m" onclick="javascript:fncOpenMap('BSC','<c:out value="${resultInfo.gid}"/>'); return false;"></button>
