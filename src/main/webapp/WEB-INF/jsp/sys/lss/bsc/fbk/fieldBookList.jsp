...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<fieldset>
			...
			<form id="listForm" action="/sys/lss/bsc/fbk/selectFieldBookList.do" method="post">
			...
			<sec:authorize access="hasAnyRole('ROLE_USER_CNRS','ROLE_ADMIN_BSC','ROLE_SUB_ADMIN','ROLE_ADMIN')">
			<div class="BtnGroup">
