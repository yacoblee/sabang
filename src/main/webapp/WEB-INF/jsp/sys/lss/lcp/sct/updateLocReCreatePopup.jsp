...
<div class="sub-upload">
    <div class="BoardDetail">
    	<form:form id="updateLocForm" method="post" action="/sys/lss/lcp/sct/updateLocReCreate.do">
    	...
    	<table class="fieldBookTable">
    		<colgroup>
         	...
         	<tr>
	      	...
	      	<tr>
	      		<c:set var="title">등급</c:set>
			  	<th>${title}</th>
			  	<td colspan="2">
					<label for="lastGrd" class="Hidden">${title}</label>
					<select id="lastGrd" name="lastGrd" title="${title}">
