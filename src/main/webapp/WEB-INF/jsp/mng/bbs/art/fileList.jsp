...
<script type="text/javascript">
	...
	function fn_egov_downFile(atchFileId, fileSn){
		window.open("<c:url value='/mng/bbs/art/articleFileDownload.do?atchFileId="+atchFileId+"&fileSn="+fileSn+"'/>");
	}
	...
	function fn_egov_deleteFile(atchFileId, fileSn, delTrName) {
		...
		newForm.method = "post";
		newForm.action = "<c:url value='/mng/bbs/art/deleteFileInfs.do'/>";
