...
<div class="wrap-right" id="Cont">
	...
	<div id="contents">
		<form:form id="listForm" commandName="articleVO" action="${pageContext.request.contextPath}/mng/bbs/art/articleRegist.do" method="post" enctype="multipart/form-data">
		...
		<div class="BoardDetail">
			...
			<caption>${pageTitle} <spring:message code="title.create" /></caption>
				...
				<!-- 제목 -->
				<c:set var="title"><spring:message code="mngBbs.articleVO.regist.nttSj" /></c:set>
				<tr>
				...
				<!-- 첨부파일 -->
				<c:set var="title"><spring:message code="mngBbs.articleVO.regist.atchFile" /></c:set>
				<tr>
					<th><label for="file_1">${title}</label> </th>
					<td class="nopd" colspan="3">
						<input name="file_1" id="egovComFileUploader" type="file" title="<spring:message code="mngBbs.articleVO.regist.atchFile"/>" multiple/><!-- 첨부파일 -->
					    <div id="egovComFileList"></div>
					</td>
				</tr>
				<!-- 내용 -->
				<c:set var="title"><spring:message code="mngBbs.articleVO.regist.nttCn" /></c:set>
				<tr>
					<th>${title} <span class="pilsu">*</span></th>
