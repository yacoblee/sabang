...
public class LssLcpFieldBookVO extends ComDefaultVO {
	 ...
	 * 조사대상지 - 명칭
	 */
	private String sldNm;
	
	/**
	 * 조사대상지 - 시도
	 */
	private String sldSd;
	
	/**
	 * 조사대상지 - 시군구
	 */
	private String sldSgg;
	
	/**
	 * 조사대상지 - 읍면동
	 */
	private String sldEmd;
	
	/**
	 * 제보관리 - 시도
	 */
	private String gvfSd;
	
	/**
	 * 제보관리 - 시군구
	 */
	private String gvfSgg;
	
	/**
	 * 제보관리 - 읍면동
	 */
	private String gvfEmd;
	
	/**
	 * 조사대상지 - 법정동코드
	 */
	private String sldStdgCd;

	/**
	 * 제보관리 - 법정동코드
	 */
	private String gvfStdgCd;
	
	/**
	 * 조사대상지 등록개수
	 */
	private String sldCnt;
	
	/**
	 * 제보관리 등록개수
	 */
	private String gvfCnt;
	...
	public String getSldNm() {
		return sldNm;
	}

	public void setSldNm(String sldNm) {
		this.sldNm = sldNm;
	}

	public String getSldSd() {
		return sldSd;
	}

	public void setSldSd(String sldSd) {
		this.sldSd = sldSd;
	}

	public String getSldSgg() {
		return sldSgg;
	}

	public void setSldSgg(String sldSgg) {
		this.sldSgg = sldSgg;
	}

	public String getSldEmd() {
		return sldEmd;
	}

	public void setSldEmd(String sldEmd) {
		this.sldEmd = sldEmd;
	}

	public String getGvfSd() {
		return gvfSd;
	}

	public void setGvfSd(String gvfSd) {
		this.gvfSd = gvfSd;
	}

	public String getGvfSgg() {
		return gvfSgg;
	}

	public void setGvfSgg(String gvfSgg) {
		this.gvfSgg = gvfSgg;
	}

	public String getGvfEmd() {
		return gvfEmd;
	}

	public void setGvfEmd(String gvfEmd) {
		this.gvfEmd = gvfEmd;
	}
	...
	public String getSldStdgCd() {
		return sldStdgCd;
	}

	public void setSldStdgCd(String sldStdgCd) {
		this.sldStdgCd = sldStdgCd;
	}

	public String getGvfStdgCd() {
		return gvfStdgCd;
	}

	public void setGvfStdgCd(String gvfStdgCd) {
		this.gvfStdgCd = gvfStdgCd;
	}

	public String getSldCnt() {
		return sldCnt;
	}

	public void setSldCnt(String sldCnt) {
		this.sldCnt = sldCnt;
	}

	public String getGvfCnt() {
		return gvfCnt;
	}

	public void setGvfCnt(String gvfCnt) {
		this.gvfCnt = gvfCnt;
	}
