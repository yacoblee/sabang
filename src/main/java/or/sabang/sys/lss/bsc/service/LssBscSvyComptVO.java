...
public class LssBscSvyComptVO  extends ComDefaultVO{
	 ...
	 * 경사도 시점 경도
	 */
	private String slopeBpx;
	/*
	 * 경사도 시점 위도
	 */
	private String slopeBpy;
	/*
	 * 경사도 끝점 경도
	 */
	private String slopeEpx;
	/*
	 * 경사도 끝점 위도
	 */
	private String slopeEpy;
	/*
	 * 경사길이 시점 경도
	 */
	private String slenBpx;
	/*
	 * 경사길이 시점 위도
	 */
	private String slenBpy;
	/*
	 * 경사길이 끝점 경도
	 */
	private String slenEpx;
	/*
	 * 경사길이 끝점 위도
	 */
	private String slenEpy;
	...
	public String getSlopeBpx() {
		return slopeBpx;
	}
	public void setSlopeBpx(String slopeBpx) {
		this.slopeBpx = slopeBpx;
	}
	public String getSlopeBpy() {
		return slopeBpy;
	}
	public void setSlopeBpy(String slopeBpy) {
		this.slopeBpy = slopeBpy;
	}
	public String getSlopeEpx() {
		return slopeEpx;
	}
	public void setSlopeEpx(String slopeEpx) {
		this.slopeEpx = slopeEpx;
	}
	public String getSlopeEpy() {
		return slopeEpy;
	}
	public void setSlopeEpy(String slopeEpy) {
		this.slopeEpy = slopeEpy;
	}
	public String getSlenBpx() {
		return slenBpx;
	}
	public void setSlenBpx(String slenBpx) {
		this.slenBpx = slenBpx;
	}
	public String getSlenBpy() {
		return slenBpy;
	}
	public void setSlenBpy(String slenBpy) {
		this.slenBpy = slenBpy;
	}
	public String getSlenEpx() {
		return slenEpx;
	}
	public void setSlenEpx(String slenEpx) {
		this.slenEpx = slenEpx;
	}
	public String getSlenEpy() {
		return slenEpy;
	}
	public void setSlenEpy(String slenEpy) {
		this.slenEpy = slenEpy;
	}
	public String getRegion1GroupId() {
		return region1GroupId;
	}
	public void setRegion1GroupId(String region1GroupId) {
		this.region1GroupId = region1GroupId;
	}
}
