...
public class FckMseFieldBookVO extends ComDefaultVO {
	 ...
	 * 조사유형
	 */
	private String svy_type;
	
	/**
	 * 조사단계
	 */
	private String svy_step;
	...
	public String getSvy_type() {
		return svy_type;
	}

	public void setSvy_type(String svy_type) {
		this.svy_type = svy_type;
	}
	
	public String getSvy_step() {
		return svy_step;
	}

	public void setSvy_step(String svy_step) {
		this.svy_step = svy_step;
	}
