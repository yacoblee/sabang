package or.sabang.sys.uia.service.impl;
...
//    	result = sndngMailRegistService.insertSndngMail(sndngMailVO);
	...
	public int idCheck(String mberId) throws Exception{
    	return loginDAO.idCheck(mberId);
    }
	 ...
	 */
	public boolean actionLoginCheck() throws Exception{
		return true;
	}
	/**
	 * 로그인로그 이력저장을 위한 로그아웃 여부를 체크한다.
	 */
	public boolean actionLogoutCheck() throws Exception{
		return true;
	}
}
