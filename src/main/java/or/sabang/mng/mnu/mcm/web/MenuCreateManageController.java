package or.sabang.mng.mnu.mcm.web;
...
import or.sabang.mng.mnu.mcm.service.MenuCreateManageService;
import or.sabang.mng.mnu.mcm.service.MenuCreatVO;
import or.sabang.mng.mnu.mcm.service.MenuSiteMapVO;
...
public class MenuCreateManageController {
	...
	@RequestMapping(value = "/mng/mnu/mcm/menuCreatManageSelect.do")
	public String selectMenuCreatManagList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		*/
		...
		return "mng/mnu/mcm/menuCreatManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/mng/mnu/mcm/menuCreatSelect.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/mng/mnu/mcm/menuCreatInsert.do")
	public ModelAndView insertMenuCreatList(@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert, @RequestParam("checkedMenuNoForInsert") String checkedMenuNoForInsert,
...
//		String currentPath = MenuCreateManageController.class.getProtectionDomain().getCodeSource() == null ? "" : EgovStringUtil.isNullToString(MenuCreateManageController.class.getProtectionDomain().getCodeSource().getLocation().getPath());
