...
public class MainMenuManageController {
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mng/mnu/mpm/mainMenuIndex.do")
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mng/mnu/mpm/mainMenu.do")
    public String selectMainMenu(
    	...
    	List<?> list_headmenu = null;//menuManageService.selectMainMenuHead(menuManageVO);
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mng/mnu/mpm/mainMenuHead.do")
     ...
     * @exception Exception
     */
    @RequestMapping(value="/mng/mnu/mpm/mainMenuLeft.do")
     ...
     */
    /*Right Menu 조회*/
    @RequestMapping(value="/mng/mnu/mpm/mainMenuRight.do")
    ...
    @RequestMapping(value="/mng/mnu/mpm/mainMenuHome.do")
