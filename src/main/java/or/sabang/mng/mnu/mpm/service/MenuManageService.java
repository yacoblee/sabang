package or.sabang.mng.mnu.mpm.service;
...
public interface MenuManageService {
	 ...
	 * @exception Exception
	 */
	String selectMainMenuHead(MenuManageVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	List<EgovMap> selectMainMenuLeft(MenuManageVO vo) throws Exception;
