package or.sabang.mng.mnu.mpm.service.impl;
...
public class MenuManageDAO extends EgovComAbstractDAO{
	 ...
	 * @exception Exception
	 */
	public String selectMainMenuHead(MenuManageVO vo) throws Exception{
		return (String)selectOne("menuManageDAO.selectMainMenuHead", vo);
	}
	 ...
	 * @exception Exception
	 */
	public List<EgovMap> selectMainMenuLeft(MenuManageVO vo) throws Exception{
