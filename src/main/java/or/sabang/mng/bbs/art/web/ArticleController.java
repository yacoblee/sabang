...
public class ArticleController {
	 ...
	 */
	@RequestMapping(value = "/mng/bbs/art/articleList.do")
	public String selectArticleList(@ModelAttribute("articleVO") ArticleVO articleVO, FileVO fileVO, ModelMap model) throws Exception {
...
//        }
		...
		return "mng/bbs/art/articleList";
	}
	 ...
	 */
	@RequestMapping(value = "/mng/bbs/art/selectArticleDetail.do")
	public String selectArticleDetail(ArticleVO articleVO, FileVO fileVO, @ModelAttribute("commentVO") CommentVO commentVO, ModelMap model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
...
//		List<CommentVO> cmtList =  articleCommentService.selectArticleCommentList(commentVO);
		...
		return "mng/bbs/art/articleDetail";
	}
	 ...
	 */ 
	@RequestMapping(value = "/mng/bbs/art/articleRegistView.do")
	public String insertArticleView(ArticleVO articleVO, ModelMap model) throws Exception {
		return "mng/bbs/art/articleRegist";
	}
	 ...
	 * @description 게시물 등록
	 */
	@RequestMapping(value = "/mng/bbs/art/articleRegist.do")
...
//			}
	 ...
	 */
	@RequestMapping("/mng/bbs/art/updateArticleView.do")
	public String updateArticleView(ArticleVO articleVO, FileVO fileVO, ModelMap model) throws Exception {
		...
		return "mng/bbs/art/articleUpdt";  
    }
	 ...
	 * @description 게시물 수정
	 */
	@RequestMapping("/mng/bbs/art/articleUpdate.do")
	 ...
	 * @description 게시물 삭제
	 */
	@RequestMapping("/mng/bbs/art/articleDelete.do")
     ...
     */
    @RequestMapping("/mng/bbs/art/selectFileInfs.do")
     ...
     */
    @RequestMapping("/mng/bbs/art/selectFileInfsForUpdate.do")
     ...
     */
    @RequestMapping("/mng/bbs/art/deleteFileInfs.do")
     ...
     */
    @RequestMapping("/mng/bbs/art/articleFileDownload.do")
