...
public class UserAuthor extends ComDefaultVO {
	/**
	 * serialVersionUID
	 */
	...
	/**
	 * userTyCode attribute 값을 설정한다.
	 * @param userTyCode String 
	 */
	public void setUserTyCode(String userTyCode) {
		this.userTyCode = userTyCode;
	}
	/**
	 * userTyNm attribute 를 리턴한다.
	 * @return String
	 */
	...
	/**
	 * userTyNm attribute 값을 설정한다.
	 * @param userTyNm String 
	 */
