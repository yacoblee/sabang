package or.sabang.mng.sec.drm.service.impl;
...
public class DeptAuthorDAO extends EgovComAbstractDAO {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<EgovMap> selectDeptNmList(HashMap<String, Object> map) throws Exception {
		return (List<EgovMap>) list("deptAuthorDAO.selectDeptNmList", map);
	}
}