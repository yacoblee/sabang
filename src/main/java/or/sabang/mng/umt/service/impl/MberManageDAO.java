...
public class MberManageDAO extends EgovComAbstractDAO{
    ...
    public int deleteMber(String delId){
        return (int)delete("mberManageDAO.deleteMber_S", delId);
    }
    ...
    public int insertMber(MberManageVO mberManageVO){
        return (int)insert("mberManageDAO.insertMber_S", mberManageVO);
    }
    ...
    public int updateMber(MberManageVO mberManageVO){
        return (int)update("mberManageDAO.updateMber_S",mberManageVO);
    }

    public int resetMberPassword(MberManageVO mberManageVO) {
    	return (int)update("mberManageDAO.updatePassword_S", mberManageVO);
    }
    /**
     * 일반회원 약관확인
...
//    }
    ...
    public int updatePassword(MberManageVO passVO) {
        return (int)update("mberManageDAO.updatePassword_S", passVO);
    }
     ...
     * @throws Exception
     */
    public int updateAccept(String mberId){
    	return (int) update("mberManageDAO.updateAccept_S", mberId);
    }
     ...
     */
    public int updateLockIncorrect(MberManageVO mberManageVO) {
        return (int)update("mberManageDAO.updateLockIncorrect", mberManageVO);
    }
	...
	public List<?> selectMberListExcel(UserDefaultVO userSearchVO) throws Exception{
    	return list("mberManageDAO.selectMberListExcel",userSearchVO);
    }
}