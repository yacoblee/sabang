...
public interface MberManageService {
	 ...
	 * @throws Exception
	 */
	public int deleteMber(String checkedIdForDel) throws Exception;
...
//	public List<?> selectStplat(String stplatId)  throws Exception;
	 ...
	 * @throws Exception
	 */
	public int updatePassword(MberManageVO mberManageVO) throws Exception;
     ...
     * @throws Exception
     */
	public int updateAccept(String mberId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Map<?,?> selectMberListExcel(UserDefaultVO userSearchVO) throws Exception;
}