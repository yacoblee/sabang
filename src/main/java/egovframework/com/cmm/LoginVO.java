...
public class LoginVO implements Serializable{
	...
	/** GPKI인증 DN */
	private String dn;
	private JSONArray accesMenu;
	private JSONArray accesLeftMenu;
	/**
	 * id attribute 를 리턴한다.
	 * @return String
	 */
	...
	public JSONArray getAccesMenu() {
		return accesMenu;
	}
	public void setAccesMenu(JSONArray accesMenu) {
		this.accesMenu = accesMenu;
	}
	public JSONArray getAccesLeftMenu() {
		return accesLeftMenu;
	}
	public void setAccesLeftMenu(JSONArray accesLeftMenu) {
		this.accesLeftMenu = accesLeftMenu;
	}
